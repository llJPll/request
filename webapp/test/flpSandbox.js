		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Order Request",
									"targetURL": "#nsindraorderrequest-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nsindraorderrequest-display": {
								"semanticObject": "nsindraorderrequest",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.indra.orderrequest",
									"url": sap.ui.require.toUrl("ns/indra/orderrequest")
								}
							}
						}
					}
